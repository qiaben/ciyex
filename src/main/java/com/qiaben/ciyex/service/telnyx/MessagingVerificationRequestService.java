...
public class MessagingVerificationRequestService {

    private final TelnyxProperties properties;

    public MessagingVerificationRequestDTO listVerificationRequests(
            int page,
            int pageSize,
            String dateStart,
            String dateEnd,
        ...
        return client.get()
                .uri(uri)
                .retrieve()
                .body(MessagingVerificationRequestDTO.class);
    }
}
