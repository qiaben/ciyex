...
public class TelnyxPushCredentialService {

    private final TelnyxProperties telnyxProperties;

    public TelnyxPushCredentialResponseDTO getPushCredentialById(String id) {
        ...
        try {
            ...
            TelnyxPushCredentialResponseDTO dto = new TelnyxPushCredentialResponseDTO();
