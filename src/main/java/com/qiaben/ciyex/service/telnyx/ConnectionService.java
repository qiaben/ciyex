...
public class ConnectionService {
    ...
    public ConnectionResponseDto listConnections(
            Integer pageNumber,
            Integer pageSize,
        ...
        return restClient.get()
                ...
                .retrieve()
                .body(ConnectionResponseDto.class);
    }

    public ConnectionResponseDto.ConnectionData getConnectionById(String id) {
        RestClient restClient = RestClient.builder().baseUrl(properties.getApiBaseUrl()).build();

        ConnectionResponseDto response = restClient.get()
