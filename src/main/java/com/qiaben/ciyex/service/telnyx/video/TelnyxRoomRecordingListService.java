...
public class TelnyxRoomRecordingListService {

    private final RestClient restClient;
    private final TelnyxProperties telnyxProperties;

    public TelnyxRoomRecordingListResponseDto listRoomRecordings(Map<String, String> filters) {
        ...
        return restClient.get()
                ...
                .retrieve()
                .body(TelnyxRoomRecordingListResponseDto.class);
    }
}
