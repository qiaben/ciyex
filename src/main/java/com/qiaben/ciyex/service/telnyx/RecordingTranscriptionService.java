...
public class RecordingTranscriptionService {
    ...
    public RecordingTranscriptionListResponseDto list(String accountSid, Integer pageSize, String pageToken) {
        ...
        return restClient.get()
                ...
                .retrieve()
                .body(RecordingTranscriptionListResponseDto.class);
    }

    public RecordingTranscriptionDto get(String accountSid, String transcriptionSid) {
        String uri = telnyxProperties.getApiBaseUrl()
        ...
        return restClient.get()
                ...
                .header("Authorization", "Bearer " + telnyxProperties.getApiKey())
                .retrieve()
                .body(RecordingTranscriptionDto.class);
    }
