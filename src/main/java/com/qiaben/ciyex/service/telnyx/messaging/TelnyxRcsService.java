...
public class TelnyxRcsService {
    ...
    // GET capabilities
    public TelnyxRcsCapabilitiesDTO listCapabilities(String agentId, String phoneE164) {
        ...
        return client()
                ...
                .retrieve()
                .body(TelnyxRcsCapabilitiesDTO.class);
    }

    // POST invite
    public TelnyxRcsTestNumberInviteDTO inviteTestNumber(String agentId, String phoneE164) {
        ...
        return client()
                ...
                .accept(MediaType.APPLICATION_JSON)
                .retrieve()
                .body(TelnyxRcsTestNumberInviteDTO.class);
    }
}
