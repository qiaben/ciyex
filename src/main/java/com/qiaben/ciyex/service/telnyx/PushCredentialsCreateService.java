...
public class PushCredentialsCreateService {

    private final TelnyxProperties telnyxProperties;
    private final ObjectMapper objectMapper;

    public PushCredentialsResponseDto createPushCredential(PushCredentialsCreateDto dto) {
        ...
        try {
            ...
            return objectMapper.convertValue(data, PushCredentialsResponseDto.class);
