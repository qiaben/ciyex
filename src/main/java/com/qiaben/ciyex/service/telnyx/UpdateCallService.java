package com.qiaben.ciyex.service.telnyx;   // ← must match folder
...
public class UpdateCallService {
    ...
    public CallResponseDto updateCall(String accountSid, String callSid, UpdateCallRequestDto request) {
