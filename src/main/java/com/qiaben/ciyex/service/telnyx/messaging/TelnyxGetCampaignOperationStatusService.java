...
public class TelnyxGetCampaignOperationStatusService {

    private final TelnyxProperties properties;
    private final RestClient restClient = RestClient.builder().build();

    public TelnyxGetCampaignOperationStatusResponseDTO getStatus(String campaignId) {
        ...
        return restClient.get()
                ...
                .retrieve()
                .body(TelnyxGetCampaignOperationStatusResponseDTO.class);
    }
}
