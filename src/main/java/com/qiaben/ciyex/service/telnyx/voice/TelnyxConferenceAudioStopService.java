...
public class TelnyxConferenceAudioStopService {

    private final TelnyxProperties telnyxProperties;
    private final RestClient restClient = RestClient.create();

    public TelnyxConferenceAudioStopResponseDto stopAudio(String conferenceId, TelnyxConferenceAudioStopRequestDto request) {
        ...
        return restClient.post()
                ...
                .body(request)
                .retrieve()
                .body(TelnyxConferenceAudioStopResponseDto.class);
    }
}
