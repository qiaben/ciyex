...
public class PushCredentialsListService {

    private final TelnyxProperties telnyxProperties;
    private final ObjectMapper objectMapper;

    public PushCredentialsListResponseDto listPushCredentials(String type, String alias, Integer pageSize, Integer pageNumber) {
        ...
        try {
            ...
            return objectMapper.convertValue(response, PushCredentialsListResponseDto.class);
