...
public class ExternalOrgStorageResolver {
    ...
    // No-op implementation for cases with no external storage
    private static class NoOpExternalOrgStorage implements ExternalOrgStorage {
        @Override
        public String create(com.qiaben.ciyex.entity.Org localOrg) {
            return null;
        }

        @Override
        public void update(com.qiaben.ciyex.entity.Org localOrg, String externalId) {
        }

        @Override
        public com.qiaben.ciyex.entity.Org get(String externalId) {
            return null;
        }
