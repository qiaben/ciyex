...
@StorageType("fhir")
@Component("fhirExternalPastMedicalHistoryStorage")
@RequiredArgsConstructor
@Slf4j
public class FhirExternalPastMedicalHistoryStorage implements ExternalStorage<PastMedicalHistoryDto> {
    ...
    @Override
    public void update(PastMedicalHistoryDto dto, String externalId) {
        String tenantName = tenantName();
    ...
    @Override
    public PastMedicalHistoryDto get(String externalId) {
        String tenantName = tenantName();
        ...
        return executeWithRetry(() -> {
            ...
            PastMedicalHistoryDto dto = mapFromFhir(observation);
    ...
    @Override
    public List<PastMedicalHistoryDto> searchAll() {
        // Not implemented
    ...
    public boolean supports(Class<?> entityType) {
        return PastMedicalHistoryDto.class.isAssignableFrom(entityType);
    }

    private Observation mapToFhir(PastMedicalHistoryDto dto, String tenantName) {
        ...
        code.setText("Past Medical History");
    ...
    private PastMedicalHistoryDto mapFromFhir(Observation observation) {
