-- V58: Add room assignment field to appointments
-- Rooms are configurable options; staff can assign a room from the appointments table.
  ...
  "sections": [
    {
      ...
      "fields": [
        ...
        {"key":"status","label":"Status","type":"select","required":true,"colSpan":1,
         ...
         "showInTable":true},
        {"key":"room","label":"Room","type":"select","required":false,"colSpan":1,
         "options":["Exam 1","Exam 2","Exam 3","Exam 4","Lab","Procedure Room","Triage"],
         "showInTable":true,
         "fhirMapping":{"resource":"Appointment","path":"extension.where(url=''room'').valueString","type":"string"}},
