-- V125: Fix payment date FHIR mapping type
-- Invoice.date is dateTime in FHIR R4, not date
-- This caused the payment date to not be read back from FHIR
...
SET field_config = '{
  "sections": [
    ...
    },
    {
      ...
      "collapsed": false,
      "fields": [
        {"key":"date","label":"Payment Date","type":"date","required":true,"colSpan":1,"showInTable":true,"defaultToday":true,"fhirMapping":{"resource":"Invoice","path":"date","type":"dateTime"}},
