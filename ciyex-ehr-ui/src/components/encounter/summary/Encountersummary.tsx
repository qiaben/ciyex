...
//     try {
//         const res = await fetchWithOrg(url, { headers: { Accept: "application/json" } as any });
...
//
//     // Header meta
//     const [encMeta, setEncMeta] = useState<any | null>(null);
//
//     // Sections
//     const [assignedProviders, setAssignedProviders] = useState<any[] | null>(null);
//     const [chiefComplaints, setChiefComplaints] = useState<any[] | null>(null);
//     const [hpi, setHpi] = useState<any[] | null>(null);
//     const [pmh, setPmh] = useState<any[] | null>(null);
//     const [patientMH, setPatientMH] = useState<any[] | null>(null);
//     const [fh, setFh] = useState<any[] | null>(null);
//     const [sh, setSh] = useState<{ entries?: any[] } | null>(null);
//     const [ros, setRos] = useState<any[] | null>(null);
//     const [pe, setPe] = useState<any[] | null>(null);
//     const [procedures, setProcedures] = useState<any[] | null>(null);
//     const [codes, setCodes] = useState<any[] | null>(null);
//     const [assessment, setAssessment] = useState<any[] | null>(null);
//     const [plan, setPlan] = useState<any[] | null>(null);
//     const [providerNotes, setProviderNotes] = useState<any[] | null>(null);
//     const [providerSignature, setProviderSignature] = useState<any | null>(null);
//     const [signoff, setSignoff] = useState<any | null>(null);
//     const [dateTimeFinalized, setDateTimeFinalized] = useState<any | null>(null);
//
...
//                     ]),
//                     tryMany<any[]>([`/api/codes/${patientId}/${encounterId}`]),
//                     tryMany<any[]>([
//                         `/api/assessment/${patientId}/${encounterId}`,
//                         `/api/assessments/${patientId}/${encounterId}`,
//                     ]),
//                     tryMany<any[]>([`/api/plan/${patientId}/${encounterId}`, `/api/plans/${patientId}/${encounterId}`]),
//                     tryMany<any[]>([`/api/provider-notes/${patientId}/${encounterId}`, `/api/soap/${patientId}/${encounterId}`]),
//                     tryMany<any>([`/api/provider-signatures/${patientId}/${encounterId}`, `/api/signatures/${patientId}/${encounterId}`]),
//                     tryMany<any>([`/api/signoffs/${patientId}/${encounterId}`, `/api/sign-off/${patientId}/${encounterId}`]),
//                     tryMany<any>([`/api/datetime-finalized/${patientId}/${encounterId}`, `/api/finalized/${patientId}/${encounterId}`]),
//                 ]);
//
//                 if (!alive) return;
//
//                 // Normalize Social History: accept array or object-with-entries
//                 let soc: { entries?: any[] } | null = null;
//                 if (Array.isArray(socRaw)) soc = { entries: socRaw };
//                 else if (socRaw && typeof socRaw === "object") soc = socRaw as any;
//
//                 setEncMeta(meta);
...
//             } catch (e: any) {
//                 if (!alive) return;
//                 setTopErr(e?.message ?? "Failed to load summary");
//             } finally {
...
//                             {"visitCategory" in encMeta && <div className="row"><b>Visit Category:</b> {String(encMeta.visitCategory)}</div>}
//                             {"type" in encMeta &&         <div className="row"><b>Type:</b> {String(encMeta.type)}</div>}
//                             {"facility" in encMeta &&     <div className="row"><b>Facility:</b> {String(encMeta.facility)}</div>}
//                             {"dateOfService" in encMeta &&<div className="row"><b>Date of service:</b> {String(encMeta.dateOfService)}</div>}
//                             {"reasonForVisit" in encMeta && (
...
//                             {assignedProviders.map((p: any, i: number) => (
//                                 <li key={p?.id ?? i}>
...
//                             {chiefComplaints.map((cc: any, i: number) => (
...
//                     <Section title="SOAP">
//                         {providerNotes.map((n: any, i: number) => (
