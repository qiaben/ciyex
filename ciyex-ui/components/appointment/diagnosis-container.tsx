...
import { getCurrentUserFromToken } from "@/utils/auth"; // <--- Use your auth
...
export const DiagnosisContainer = async ({
  ...
  // Use JWT roles for checkRole
  const isPatient = checkRole("PATIENT", user.roles);
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div className="space-y-4">
                          <div>
                            ...
                            <p className="text-slate-800 dark:text-slate-200 font-semibold text-lg">{record.diagnosis}</p>
                          </div>
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-slate-800 dark:text-slate-200 font-medium">{record.doctor.name}</p>
                              <p className="text-blue-600 dark:text-blue-400 text-sm">{record.doctor.specialization}</p>
                            </div>
                          </div>
                        </div>
                      </div>
