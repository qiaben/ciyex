...
import { getCurrentUserFromToken } from "../../../utils/auth"; // Import JWT-related function from utils/auth.ts
...
export default function SignInPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Use getCurrentUserFromToken to verify user role from the token
