...
// ------ Replace with your own auth context or utility ------
function useCurrentUser() {
  // You should replace this with your JWT/context user retrieval
  if (typeof window === "undefined") return { userId: undefined };
  try {
    const raw = localStorage.getItem("user");
    if (!raw) return { userId: undefined };
    const user = JSON.parse(raw);
    return { userId: user.userId }; // Customize to match your JWT shape
  } catch {
