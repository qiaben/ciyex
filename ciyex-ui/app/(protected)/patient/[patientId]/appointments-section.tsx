...
export default function AppointmentsSection({ patientId }: AppointmentsSectionProps) {
    ...
    const isPatient = userId === Number(patientId); // Convert patientId to a number for the comparison
                        ...
                        <div className="space-y-4">
                          ...
                          {appointment.status.charAt(0) + appointment.status.slice(1).toLowerCase()}
                                            ...
                                            <div className="flex items-center gap-4 text-xs text-gray-500 mt-1">
                                                ...
                                                <span>
                          ⏰{" "}
                                                    {appointmentDateTime && !isNaN(appointmentDateTime.getTime()) ? format(appointmentDateTime, "p") : "-"}
                        </span>
                                            </div>
                                        </div>
