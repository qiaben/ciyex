...
import { useAuthUser } from '@/hooks/useAuthUser'; // <--- Your JWT context/hook
  ...
  return (
      <>
        ...
        <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8 max-w-6xl w-full">
          ...
          {/* ... THE REST OF YOUR RENDERED JSX GOES HERE, UNCHANGED ... */}
          {/* For brevity, copy your main render logic for lists, dialogs, order cards, etc., from your working version. */}
          {/* Just remember to use user from JWT context instead of Clerk and remove all Clerk usage! */}
        </div>
      </>
  );
};
