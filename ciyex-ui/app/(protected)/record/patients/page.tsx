...
const PatientList = async (props: SearchParamsProps) => {
  ...
  // Only show patients who have at least one appointment with the doctor
  const filteredData = data.filter((item: PatientProps) => (item.appointments && item.appointments.length > 0));
  ...
  return (
    <div className="bg-white rounded-xl py-6 px-3 2xl:px-6">
      ...
      <div className="mt-4">
        <Table columns={columns} data={filteredData} renderRow={renderRow} />
