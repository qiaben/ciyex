...
// JWT-based auth context/hook (replace with your own implementation)
import { useAuthUser } from '@/hooks/useAuthUser';

const specializations = [/* ... your specializations ... */];
const usStates = [/* ... your states ... */];
              ...
              <CardContent>
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    {/* ...All your FormField JSX as before (unchanged)... */}
                    {/* See your original form fields for full code */}
                    {/* ... */}
